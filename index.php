...
<html lang="en">
    ...
    <body>
        ...
        <section class="section-steps">
            ...
            <div class="row">
                ...
                <div class="col span-1-of-2 steps-box">
                    ...
                    <a href="#" class="btn-app"><img src="public/img/download-app.svg" alt="App Store button"></a>
                    <a href="#" class="btn-app"><img src="public/img/download-app-android.png" alt="Google Play button"></a>
                </div>
            </div>
        </section>
        ...
        <section class="section-cities">
            ...
            <div class="row">
                <div class="col span-1-of-4 box">
                    <img src="public/img/lisbon-3.jpg" alt="Lisbon photo" class="city-photo">
                    <h3>Lisbon</h3>
                    <div class="city-info">
                        ...
                        <a href="#" class="twitter">@omnifood_lx</a>
                    </div>
                </div>
                <div class="col span-1-of-4 box">
                    <img src="public/img/san-francisco.jpg" alt="San Francisco photo" class="city-photo">
                    <h3>San Francisco</h3>
                    <div class="city-info">
                        <i class="ion-person icon-small"></i>
                        ...
                        160+ top chefs<br>
                        <i class="ion-social-twitter icon-small"></i>
                        <a href="#" class="twitter">@omnifood_sf</a>
                    </div>
                </div>
                <div class="col span-1-of-4 box">
                    <img src="public/img/berlin.jpg" alt="Berlin photo" class="city-photo">
                    <h3>Berlin</h3>
                    <div class="city-info">
                        <i class="ion-person icon-small"></i>
                        ...
                        110+ top chefs<br>
                        <i class="ion-social-twitter icon-small"></i>
                        <a href="#" class="twitter">@omnifood_berlin</a>
                    </div>
                </div>
                <div class="col span-1-of-4 box">
                    <img src="public/img/london.jpg" alt="London photo" class="city-photo">
                    <h3>London</h3>
                    <div class="city-info">
                        <i class="ion-person icon-small"></i>
                        ...
                        50+ top chefs<br>
                        <i class="ion-social-twitter icon-small"></i>
                        <a href="#" class="twitter">@omnifood_london</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section-customers">
            ...
            <div class="row">
                <div class="col span-1-of-3 box">
                    <blockquote>Omnifood is just awesome! I just launched a startup which leaves me with no time for cooking, so Omnifood is a life-saver. Now that I got used to it, I couldn't live without my daily meals!<br>
                        <cite><img src="public/img/customer-1.jpg" alt="Customer 1" class="customer-photo">Alberto Duncan</cite>
                    </blockquote>
                </div>
                
                <div class="col span-1-of-3 box">
                    <blockquote>Inexpensive, healthy and great-tasting meals, delivered right to my home. We have lots of food delivery here in Lisbon, but no one comes even close to Omifood. Me and my family are so in love!<br>
                        <cite><img src="public/img/customer-2.jpg" alt="Customer 2" class="customer-photo">Joana Silva</cite>
                    </blockquote>
                    
                </div>
                
                <div class="col span-1-of-3 box">
                    <blockquote>I was looking for a quick and easy food delivery service in San Franciso. I tried a lot of them and ended up with Omnifood. Best food delivery service in the Bay Area. Keep up the great work!<br>
                        <cite><img src="public/img/customer-3.jpg" alt="Customer 3" class="customer-photo">Milton Chapman</cite>
                    </blockquote>
